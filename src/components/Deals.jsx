  ...
  return (
    <div className="dark:bg-gray-900 dark:text-white">
      <div className=" min-h-screen container flex flex-col justify-center pt-16 md:pt-0">
        {/* heading  */}
        <h1 className=" font-semibold text-4xl text-center text-secondary dark:text-gray-200 mt-5">
          Hot Deals
        </h1>
        ...
        <div className=" flex flex-col md:flex-row gap-10 mt-8">
          ...
          <div className=" w-full md:w-2/4 text-center md:text-start space-y-4">
            ...
            <h3 className=" text-3xl md:text-4xl font-semibold text-secondary dark:text-gray-200">
